...
namespace Handyman.Migrations
{
    ...
    public partial class Testing123456 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "Address", "AppointmentDate", "AppointmentTime", "CustomerProfileId", "PersonName", "ProviderServiceId", "ServiceId", "Status", "UserId", "notes" },
                values: new object[,]
                {
                    { 1, "123 Main St, Springfield, IL", new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 0, 0, 0), null, "John Doe", null, 1, "Pending", "user1", "Customer requested a quick repair of the sink." },
                    { 2, "456 Elm St, Springfield, IL", new DateTime(2025, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 14, 30, 0, 0), null, "Jane Smith", null, 2, "Confirmed", "user2", "Routine maintenance of air conditioning system." }
                });
