    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St, Anytown, USA", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1910), "john.doe@example.com", "John Doe", "jhon123", "123-456-7890", null, "Customer", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1912), "customer1" },
                    { 2, "456 Elm St, Othertown, USA", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1915), "jane.smith@example.com", "Jane Smith", "jane123", "987-654-3210", null, "Customer", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1916), "customer2" },
                    { 3, "789 Oak St, Sometown, USA", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1918), "mike.johnson@example.com", "Mike Johnson", "mike123", "555-123-4567", null, "Provider", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1918), "provider1" },
                    { 4, "321 Pine St, Anothertown, USA", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1920), "emily.davis@example.com", "Emily Davis", "emily123", "555-987-6543", null, "Provider", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(1920), "provider2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2288), "https://example.com/images/lawn_mowing.jpg", "Experienced in lawn mowing with professional equipment.", 1, 1, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2288) },
                    { 2, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2290), "https://example.com/images/house_cleaning.jpg", "Thorough house cleaning services with eco-friendly products.", 2, 3, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2291) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 18, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2310), new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2315), "Please make sure to trim the edges.", 1, false, 1, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2315) },
                    { 2, new DateTime(2025, 2, 20, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2317), new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2318), "Focus on the kitchen and living room.", 2, false, 2, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2319) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2336), 1, "Great service! Very satisfied.", false, 5, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2337) },
                    { 2, 2, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2339), 2, "Good job, but could be more thorough.", false, 4, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2340) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 50.00m, 1, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2381), 1, true, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2380), "Credit Card", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2382) },
                    { 2, 75.00m, 2, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2384), 2, true, new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2384), "PayPal", new DateTime(2025, 2, 15, 2, 41, 45, 341, DateTimeKind.Utc).AddTicks(2385) }
                });
