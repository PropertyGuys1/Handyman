    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St, Anytown, USA", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5831), "john.doe@example.com", "John Doe", "jhon123", "123-456-7890", null, "Customer", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5835), "customer1" },
                    { 2, "456 Elm St, Othertown, USA", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5839), "jane.smith@example.com", "Jane Smith", "jane123", "987-654-3210", null, "Customer", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5840), "customer2" },
                    { 3, "789 Oak St, Sometown, USA", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5842), "mike.johnson@example.com", "Mike Johnson", "mike123", "555-123-4567", null, "Provider", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5843), "provider1" },
                    { 4, "321 Pine St, Anothertown, USA", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5847), "emily.davis@example.com", "Emily Davis", "emily123", "555-987-6543", null, "Provider", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(5847), "provider2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6729), "https://example.com/images/lawn_mowing.jpg", "Experienced in lawn mowing with professional equipment.", 1, 1, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6730) },
                    { 2, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6734), "https://example.com/images/house_cleaning.jpg", "Thorough house cleaning services with eco-friendly products.", 2, 3, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6735) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 17, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6784), new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6792), "Please make sure to trim the edges.", 1, false, 1, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6792) },
                    { 2, new DateTime(2025, 2, 19, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6795), new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6796), "Focus on the kitchen and living room.", 2, false, 2, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6797) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6842), 1, "Great service! Very satisfied.", false, 5, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6843) },
                    { 2, 2, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6848), 2, "Good job, but could be more thorough.", false, 4, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6848) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 50.00m, 1, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6936), 1, true, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6935), "Credit Card", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6936) },
                    { 2, 75.00m, 2, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6944), 2, true, new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6943), "PayPal", new DateTime(2025, 2, 14, 20, 41, 58, 191, DateTimeKind.Utc).AddTicks(6944) }
                });
