...
namespace Handyman.Data.MockData
{
    public static class MockData
    {
        ...
        public static List<Service> GetServices()
        {
            ...
            {
                // Popular tasks
                new Service { Id = 1, Name = "Yardwork", ServiceTypeId = 1, IsDeleted = false, Description = "Lawn care, landscaping, and gardening tasks.", Cost = 50 },
                new Service { Id = 2, Name = "Minor Home Repair", ServiceTypeId = 1, IsDeleted = false, Description = "Basic home repairs like fixing leaks and broken fixtures.", Cost = 75 },
                new Service { Id = 3, Name = "Furniture Assembly", ServiceTypeId = 1, IsDeleted = false, Description = "Assembling furniture from flat-pack kits.", Cost = 100 },
                new Service { Id = 4, Name = "Snow Removal", ServiceTypeId = 1, IsDeleted = false, Description = "Clearing snow from driveways, walkways, and roofs.", Cost = 60 },
                new Service { Id = 5, Name = "TV Mounting", ServiceTypeId = 1, IsDeleted = false, Description = "Mounting your TV on the wall for a clean look.", Cost = 120 },
                new Service { Id = 6, Name = "Help Moving", ServiceTypeId = 1, IsDeleted = false, Description = "Assisting with moving furniture or boxes.", Cost = 80 },
                new Service { Id = 7, Name = "Handyman", ServiceTypeId = 1, IsDeleted = false, Description = "General home repairs and maintenance tasks.", Cost = 90 },
                new Service { Id = 8, Name = "Painting", ServiceTypeId = 1, IsDeleted = false, Description = "Interior and exterior painting services.", Cost = 150 },
                new Service { Id = 9, Name = "Lighting Installation", ServiceTypeId = 1, IsDeleted = false, Description = "Installing light fixtures and bulbs.", Cost = 100 },
                new Service { Id = 10, Name = "Hang Pictures", ServiceTypeId = 1, IsDeleted = false, Description = "Hanging artwork or pictures on walls.", Cost = 50 },
                new Service { Id = 11, Name = "IKEA Services", ServiceTypeId = 1, IsDeleted = false, Description = "Assembly and delivery of IKEA furniture.", Cost = 100 },

                // Featured Tasks
                new Service { Id = 12, Name = "Delivery", ServiceTypeId = 2, IsDeleted = false, Description = "Deliver packages or goods to your location.", Cost = 60 },
                new Service { Id = 13, Name = "Home Repairs", ServiceTypeId = 2, IsDeleted = false, Description = "General home repair services like plumbing, electrical work, etc.", Cost = 120 },
                new Service { Id = 14, Name = "General Cleaning", ServiceTypeId = 2, IsDeleted = false, Description = "Basic home or office cleaning services.", Cost = 80 },
                new Service { Id = 15, Name = "Assemble Furniture", ServiceTypeId = 2, IsDeleted = false, Description = "Assembling furniture like desks, chairs, or tables.", Cost = 90 },
                new Service { Id = 16, Name = "Help Moving / Hauling", ServiceTypeId = 2, IsDeleted = false, Description = "Help with moving or hauling large items.", Cost = 100 },
                new Service { Id = 17, Name = "Heavy Lifting", ServiceTypeId = 2, IsDeleted = false, Description = "Lifting and transporting heavy objects.", Cost = 80 },
                new Service { Id = 18, Name = "Personal Assistant", ServiceTypeId = 2, IsDeleted = false, Description = "Personal errands and assistance for daily tasks.", Cost = 100 },
                new Service { Id = 19, Name = "Yard Work", ServiceTypeId = 2, IsDeleted = false, Description = "Outdoor maintenance including lawn mowing and trimming.", Cost = 70 },
                new Service { Id = 20, Name = "Queue in Line", ServiceTypeId = 2, IsDeleted = false, Description = "Waiting in line for tickets, products, or services.", Cost = 40 },
                new Service { Id = 21, Name = "Organize Closet", ServiceTypeId = 2, IsDeleted = false, Description = "Organizing your closet space for a more efficient setup.", Cost = 80 },
                new Service { Id = 22, Name = "Office Administration", ServiceTypeId = 2, IsDeleted = false, Description = "Office tasks like data entry, document management, etc.", Cost = 90 },
                new Service { Id = 23, Name = "Organization", ServiceTypeId = 2, IsDeleted = false, Description = "Organizing personal spaces, offices, or garages.", Cost = 75 },

                // Handyman Services
                new Service { Id = 24, Name = "Home Repairs", ServiceTypeId = 3, IsDeleted = false, Description = "General home repair services like plumbing, electrical work, etc.", Cost = 120 },
                new Service { Id = 25, Name = "Assemble Furniture", ServiceTypeId = 3, IsDeleted = false, Description = "Assembling furniture like desks, chairs, or tables.", Cost = 90 },
                new Service { Id = 26, Name = "TV Mounting", ServiceTypeId = 3, IsDeleted = false, Description = "Mounting your TV on the wall for a clean look.", Cost = 120 },
                new Service { Id = 27, Name = "Heavy Lifting", ServiceTypeId = 3, IsDeleted = false, Description = "Lifting and transporting heavy objects.", Cost = 80 },
                new Service { Id = 28, Name = "Painting", ServiceTypeId = 3, IsDeleted = false, Description = "Interior and exterior painting services.", Cost = 150 },
                new Service { Id = 29, Name = "Plumbing", ServiceTypeId = 3, IsDeleted = false, Description = "General plumbing repairs and installations.", Cost = 130 },
                new Service { Id = 30, Name = "Yard Work", ServiceTypeId = 3, IsDeleted = false, Description = "Outdoor maintenance including lawn mowing and trimming.", Cost = 70 },
                new Service { Id = 31, Name = "Hang Pictures", ServiceTypeId = 3, IsDeleted = false, Description = "Hanging artwork or pictures on walls.", Cost = 50 },
                new Service { Id = 32, Name = "Shelf Mounting", ServiceTypeId = 3, IsDeleted = false, Description = "Mounting shelves on walls for storage and decoration.", Cost = 100 },
                new Service { Id = 33, Name = "Light Installation", ServiceTypeId = 3, IsDeleted = false, Description = "Installing light fixtures and bulbs.", Cost = 100 },
                new Service { Id = 34, Name = "Electrical Work", ServiceTypeId = 3, IsDeleted = false, Description = "Electrical installations and repairs.", Cost = 150 },
                new Service { Id = 35, Name = "Carpentry", ServiceTypeId = 3, IsDeleted = false, Description = "Custom woodwork and carpentry services.", Cost = 200 },
                new Service { Id = 36, Name = "Baby Proofing", ServiceTypeId = 3, IsDeleted = false, Description = "Child-proofing your home with safety measures.", Cost = 80 },
                new Service { Id = 37, Name = "Smart Home Installation", ServiceTypeId = 3, IsDeleted = false, Description = "Installation of smart devices like thermostats, cameras, etc.", Cost = 180 },

                // Moving Services
                new Service { Id = 38, Name = "Help Moving / Hauling", ServiceTypeId = 4, IsDeleted = false, Description = "Help with moving or hauling large items.", Cost = 100 },
                new Service { Id = 39, Name = "One Item Movers", ServiceTypeId = 4, IsDeleted = false, Description = "Moving a single item, like a couch or appliance.", Cost = 75 },
                new Service { Id = 40, Name = "Furniture Movers", ServiceTypeId = 4, IsDeleted = false, Description = "Moving large furniture from one location to another.", Cost = 150 },
                new Service { Id = 41, Name = "Junk Removal", ServiceTypeId = 4, IsDeleted = false, Description = "Removal and disposal of unwanted items or junk.", Cost = 80 },
                new Service { Id = 42, Name = "Full Service Movers", ServiceTypeId = 4, IsDeleted = false, Description = "Complete moving service, including packing, loading, and unloading.", Cost = 300 },
                new Service { Id = 43, Name = "Packing and Moving Services", ServiceTypeId = 4, IsDeleted = false, Description = "Packing up your home and moving everything to your new location.", Cost = 250 },
                new Service { Id = 44, Name = "Unpacking Services", ServiceTypeId = 4, IsDeleted = false, Description = "Unpacking boxes and organizing items in your new home.", Cost = 150 },
                new Service { Id = 45, Name = "Heavy Lifting", ServiceTypeId = 4, IsDeleted = false, Description = "Lifting and transporting heavy objects.", Cost = 80 },
                new Service { Id = 46, Name = "Furniture Removal", ServiceTypeId = 4, IsDeleted = false, Description = "Removal of old furniture that needs to be disposed of.", Cost = 90 },
                new Service { Id = 47, Name = "Couch Removal", ServiceTypeId = 4, IsDeleted = false, Description = "Removal of an old couch or sofa.", Cost = 75 },
                new Service { Id = 48, Name = "Move Furniture Up/Downstairs", ServiceTypeId = 4, IsDeleted = false, Description = "Assisting in moving furniture up or down stairs.", Cost = 100 },
