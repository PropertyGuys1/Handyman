        ...
        public static List<Service> GetServices() => new List<Service>
            {
                ...
                new Service
                {
                    ...
                    Description = "General plumbing repairs and installations.", Cost = 130.0m,
                    ImageUrl = "/images/serviceImages/PlumbingServices.jpg"
                },
                new Service
                {
                ...
                new Service
                {
                    ...
                    Description = "Mounting shelves on walls for storage and decoration.", Cost = 100.0m,
                ...
                new Service
                {
                    ...
                    Description = "Moving a single item, like a couch or appliance.", Cost = 75.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                    Id = 40, Name = "Furniture Movers", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Moving large furniture from one location to another.", Cost = 150.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                    Id = 41, Name = "Junk Removal", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Removal and disposal of unwanted items or junk.", Cost = 80.0m,
                    ImageUrl = "/images/serviceImages/JunkRemovalServices.jpg"
                },
                new Service
                {
                    Id = 42, Name = "Full Service Movers", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Complete moving service, including packing, loading, and unloading.", Cost = 300.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                    Id = 43, Name = "Packing and Moving Services", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Packing up your home and moving everything to your new location.", Cost = 250.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                    Id = 44, Name = "Unpacking Services", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Unpacking boxes and organizing items in your new home.", Cost = 150.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                ...
                new Service
                {
                    ...
                    Description = "Removal of old furniture that needs to be disposed of.", Cost = 90.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                    Id = 47, Name = "Couch Removal", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Removal of an old couch or sofa.", Cost = 75.0m,
                    ImageUrl = "/images/serviceImages/MovingServices.jpg"
                },
                new Service
                {
                    Id = 48, Name = "Move Furniture Up/Downstairs", ServiceTypeId = 4, IsDeleted = false,
                    Description = "Assisting in moving furniture up or down stairs.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/HeavyLiftingServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Decorating your home with Christmas lights.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/WinterServices.jpg"
                },
                new Service
                {
                    Id = 50, Name = "Christmas Tree Delivery", ServiceTypeId = 5, IsDeleted = false,
                    Description = "Delivery of a Christmas tree to your home.", Cost = 80.0m,
                    ImageUrl = "/images/serviceImages/WinterServices.jpg"
                ...
                new Service
                {
                    ...
                    Description = "Assembling IKEA flat-pack furniture.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/IKEAServices.jpg"
                },
                new Service
                {
                    Id = 59, Name = "Assembly of Kids Furniture", ServiceTypeId = 6, IsDeleted = false,
                    Description = "Assembling kids furniture like cribs, dressers, etc.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/AssemblyServices.jpg"
                },
                new Service
                {
                    Id = 60, Name = "Office Furniture Assembly", ServiceTypeId = 6, IsDeleted = false,
                    Description = "Assembling office furniture like desks and chairs.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/AssemblyServices.jpg"
                },
                new Service
                {
                    Id = 61, Name = "Shed Assembly", ServiceTypeId = 6, IsDeleted = false,
                    Description = "Assembling outdoor sheds or storage units.", Cost = 150.0m,
                    ImageUrl = "/images/serviceImages/AssemblyServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Shoveling snow off driveways to ensure safe access.", Cost = 70.0m,
                    ImageUrl = "/images/serviceImages/WinterServices.jpg"
                },
                new Service
                {
                    Id = 67, Name = "Winterizing Plumbing", ServiceTypeId = 7, IsDeleted = false,
                    Description = "Protecting pipes from freezing by insulating or draining them.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/PlumbingServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Maintaining your lawn with mowing, fertilization, and watering.", Cost = 80.0m,
                    ImageUrl = "/images/serviceImages/LawnServices.jpg"
                },
                new Service
                {
                    Id = 69, Name = "Tree Pruning", ServiceTypeId = 8, IsDeleted = false,
                    Description = "Trimming trees and removing dead branches for safety and appearance.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/LawnServices.jpg"
                },
                new Service
                {
                    Id = 70, Name = "Leaf Raking", ServiceTypeId = 8, IsDeleted = false,
                    Description = "Raking and removing fallen leaves from yards and lawns.", Cost = 60.0m,
                    ImageUrl = "/images/serviceImages/LawnServices.jpg"
                },
                new Service
                {
                    Id = 71, Name = "Lawn Mowing", ServiceTypeId = 8, IsDeleted = false,
                    Description = "Mowing your lawn to maintain a neat and healthy yard.", Cost = 50.0m,
                    ImageUrl = "/images/serviceImages/LawnServices.jpg"
                },
                new Service
                {
                    Id = 72, Name = "Gardening", ServiceTypeId = 8, IsDeleted = false,
                    Description = "Planting and caring for flowers, shrubs, and vegetable gardens.", Cost = 90.0m,
                    ImageUrl = "/images/serviceImages/LawnServices.jpg"
                },
                new Service
                {
                    Id = 73, Name = "Mulching", ServiceTypeId = 8, IsDeleted = false,
                    Description = "Applying mulch to garden beds to retain moisture and suppress weeds.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/LawnServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Thorough cleaning of all surfaces, including hard-to-reach areas.", Cost = 150.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                new Service
                {
                    Id = 75, Name = "Office Cleaning", ServiceTypeId = 9, IsDeleted = false,
                    Description = "Cleaning office spaces, including desks, floors, and windows.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                new Service
                {
                    Id = 76, Name = "Carpet Cleaning", ServiceTypeId = 9, IsDeleted = false,
                    Description = "Deep cleaning carpets to remove stains, dirt, and odors.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                new Service
                {
                    Id = 77, Name = "Window Cleaning", ServiceTypeId = 9, IsDeleted = false,
                    Description = "Cleaning both interior and exterior windows for clarity and shine.", Cost = 80.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                new Service
                {
                    Id = 78, Name = "Move-In/Move-Out Cleaning", ServiceTypeId = 9, IsDeleted = false,
                    Description = "Cleaning a home or apartment when moving in or out.", Cost = 150.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                new Service
                {
                    Id = 79, Name = "Pressure Washing", ServiceTypeId = 9, IsDeleted = false,
                    Description = "Using high-pressure water to clean outdoor surfaces like driveways and patios.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                new Service
                {
                    Id = 80, Name = "Post-Construction Cleaning", ServiceTypeId = 9, IsDeleted = false,
                    Description = "Cleaning up debris, dust, and materials left after construction or renovation.", Cost = 180.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Shopping for groceries and delivering them to your doorstep.", Cost = 50.0m,
                    ImageUrl = "/images/serviceImages/PersonalAssistantServices.jpg"
                },
                new Service
                {
                    Id = 82, Name = "Gift Shopping", ServiceTypeId = 10, IsDeleted = false,
                    Description = "Shopping for gifts based on your preferences and budget.", Cost = 75.0m,
                    ImageUrl = "/images/serviceImages/PersonalAssistantServices.jpg"
                },
                new Service
                {
                    Id = 83, Name = "Package Pickup & Delivery", ServiceTypeId = 10, IsDeleted = false,
                    Description = "Picking up and delivering packages to your location.", Cost = 60.0m,
                    ImageUrl = "/images/serviceImages/DeliveryServices.jpg"
                },
                new Service
                {
                    Id = 84, Name = "Personal Shopping Assistant", ServiceTypeId = 10, IsDeleted = false,
                    Description = "Assisting with shopping for clothes, gifts, or other personal items.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/PersonalAssistantServices.jpg"
                },
                new Service
                {
                    Id = 85, Name = "Errand Running", ServiceTypeId = 10, IsDeleted = false,
                    Description = "Running errands like picking up dry cleaning or post office trips.", Cost = 70.0m,
                    ImageUrl = "/images/serviceImages/PersonalAssistantServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Grocery shopping and delivery without physical interaction.", Cost = 55.0m,
                    ImageUrl = "/images/serviceImages/DeliveryServices.jpg"
                },
                new Service
                {
                    Id = 87, Name = "Contactless Furniture Assembly", ServiceTypeId = 11, IsDeleted = false,
                    Description = "Furniture assembly with minimal or no physical contact.", Cost = 95.0m,
                    ImageUrl = "/images/serviceImages/AssemblyServices.jpg"
                },
                new Service
                {
                    Id = 88, Name = "Contactless Delivery", ServiceTypeId = 11, IsDeleted = false,
                    Description = "Delivering packages or groceries without in-person contact.", Cost = 55.0m,
                    ImageUrl = "/images/serviceImages/DeliveryServices.jpg"
                },
                new Service
                {
                    Id = 89, Name = "Contactless Cleaning", ServiceTypeId = 11, IsDeleted = false,
                    Description = "Cleaning services performed with social distancing and minimal contact.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/CleaningServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Assembling IKEA furniture with ease and efficiency.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/IKEAServices.jpg"
                },
                new Service
                {
                    Id = 91, Name = "IKEA Pickup & Delivery", ServiceTypeId = 12, IsDeleted = false,
                    Description = "Picking up and delivering IKEA furniture or products to your home.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/IKEAServices.jpg"
                },
                new Service
                {
                    Id = 92, Name = "IKEA Home Installation", ServiceTypeId = 12, IsDeleted = false,
                    Description = "Installing IKEA furniture and home solutions in your space.", Cost = 150.0m,
                    ImageUrl = "/images/serviceImages/IKEAServices.jpg"
                },
                ...
                new Service
                {
                    ...
                    Description = "Mounting your TV on the wall for a sleek and modern look.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/TVMountingServices.jpg"
                },
                new Service
                {
                    Id = 94, Name = "Picture Hanging", ServiceTypeId = 13, IsDeleted = false,
                    Description = "Hanging artwork, mirrors, or other pictures on your walls.", Cost = 50.0m,
                    ImageUrl = "/images/serviceImages/PaintingMountingServices.jpg"
                },
                new Service
                {
                    Id = 95, Name = "Shelving Installation", ServiceTypeId = 13, IsDeleted = false,
                    Description = "Installing shelves to maximize storage space in your home.", Cost = 100.0m,
                    ImageUrl = "/images/serviceImages/ShelfMountingServices.jpg"
                },
                new Service
                {
                    Id = 96, Name = "Light Fixture Installation", ServiceTypeId = 13, IsDeleted = false,
                    Description = "Installing or replacing light fixtures throughout your home.", Cost = 120.0m,
                    ImageUrl = "/images/serviceImages/LightingServices.jpg"
                },
                new Service
                {
                    Id = 97, Name = "Curtain Rod Installation", ServiceTypeId = 13, IsDeleted = false,
                    Description = "Installing curtain rods for your windows.", Cost = 80.0m,
